...
describe('properties', function() {
  it('should have correct now property', () => {
    ...
    const payslipForm = ReactDOM.render(<PayslipForm now={now} />, div);
...
describe('state', function() {
  it('should have correct first name default', () => {
    ...
    const payslipForm = ReactDOM.render(<PayslipForm now={new Date()} />, div);
  ...
  it('should set error on change', () => {
    ...
    payslipForm.onChange({payslip: {}, error: error});
...
describe('validation', function() {
  ...
  it('should be invalid if first name invalid', () => {
    ...
    payslipForm.setState({super_rate: 9, annual_salary: 175000});
  ...
  describe('of date', function() {
    it('should report valid for July 2012', () => {
      ...
      const payslipForm = ReactDOM.render(<PayslipForm now={new Date('2012-07')} />, div);
    ...
    it('should report invalid for June 2012', () => {
      ...
      const payslipForm = ReactDOM.render(<PayslipForm now={new Date('2012-06')} />, div);
    ...
    it('should report invalid when no month supplied', () => {
      ...
      const payslipForm = ReactDOM.render(<PayslipForm now={new Date(2017, NaN)} />, div);
...
describe('on create', function() {
  it('should call create action', () => {
    ...
    const state = {annual_salary: 175000,
      ...
      month: new Date(),
      super_rate: 9};
    const payslipForm = ReactDOM.render(<PayslipForm now={new Date()} />,
